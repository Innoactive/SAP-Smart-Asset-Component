...
Click SAP > Creator > Configure Training and enter your XR Cloud credentials in the appearing window. Select your Scene-Type and you are ready to start creating a training with SAP content! Place the loaded Smart Assets on design-time into the scene.
...
### [SAP Smart Asset Component](https://github.com/Innoactive/SAP-Smart-Asset-Component)

*You are here.*

This component contains the Smart Asset Integration.

```
git submodule add git@github.com:Innoactive/SAP-Smart-Asset-Component.git SAP/Creator/SmartAsset
```
